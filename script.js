...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡Terrible! jajaja';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').innerHTML = '¡Oh no! ¿Estás segura bb?';
        ...
        case 1:
            ...
            document.getElementById('noBtn').innerHTML = '¡¿Realmente estas segura bb?!';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
        ...
        case 2:
            ...
            document.getElementById('noBtn').innerHTML = 'Estás segura de verdad, ¿eh bb?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
            document.getElementById('sadGifContainer2').style.display = 'none';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que si por favor xd?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'Si, dices que no estaré muy triste pipipi';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 7:
            ...
            document.getElementById('noBtn').innerHTML = 'Estaré muy triste pipipi';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 8:
            ...
            document.getElementById('noBtn').innerHTML = 'Estaré muy muy muy triste pipipi';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'Estaré muy muy muy muy triste pipipi.';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 13:
            ...
            document.getElementById('noBtn').innerHTML = 'Aqui me quede sin ideas xd :(';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
